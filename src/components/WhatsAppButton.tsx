...
export const WhatsAppButton: React.FC = () => {
  return (
    <a
      ...
      className="fixed bottom-5 left-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-[0_8px_24px_rgba(37,211,102,0.45)] transition-transform duration-200 hover:scale-110 hover:shadow-[0_10px_28px_rgba(37,211,102,0.6)] sm:h-16 sm:w-16"
    >
